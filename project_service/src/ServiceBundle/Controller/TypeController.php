...
class TypeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $types = $em->getRepository('ServiceBundle:Type')->findAll();
    ...
    {
        $type = new Type();
        $form = $this->createForm('ServiceBundle\Form\TypeType', $type);
    ...
    {
        $deleteForm = $this->createDeleteForm($type);
        $editForm = $this->createForm('ServiceBundle\Form\TypeType', $type);
