...
class BrandController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $brands = $em->getRepository('ServiceBundle:Brand')->findAll();
    ...
    {
        $brand = new Brand();
        $form = $this->createForm('ServiceBundle\Form\BrandType', $brand);
    ...
    {
        $deleteForm = $this->createDeleteForm($brand);
        $editForm = $this->createForm('ServiceBundle\Form\BrandType', $brand);
