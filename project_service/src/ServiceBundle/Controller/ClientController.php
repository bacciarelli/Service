...
class ClientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $clients = $em->getRepository('ServiceBundle:Client')->findAll();
    ...
    {
        $client = new Client();
        $form = $this->createForm('ServiceBundle\Form\ClientType', $client);
    ...
    {
        $deleteForm = $this->createDeleteForm($client);
        $editForm = $this->createForm('ServiceBundle\Form\ClientType', $client);
