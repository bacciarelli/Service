...
class PartController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $parts = $em->getRepository('ServiceBundle:Part')->findAll();
    ...
    {
        $part = new Part();
        $form = $this->createForm('ServiceBundle\Form\PartType', $part);
    ...
    {
        $deleteForm = $this->createDeleteForm($part);
        $editForm = $this->createForm('ServiceBundle\Form\PartType', $part);
